-- SupportOps Module 13: Fix empty date casting crash in save_daily_operations RPC
-- The direct cast (v_entry->>'started_at')::timestamptz crashes if started_at is an empty string "".
-- By using nullif(value, ''), empty strings are converted to NULL before casting.
