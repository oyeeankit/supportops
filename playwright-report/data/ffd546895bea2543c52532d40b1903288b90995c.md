...
- Name: dashboard.spec.ts >> Dashboard Navigation & Shell UI >> should contain key operations metric sections
...
- generic [ref=e3]:
  ...
  - generic [ref=e36]:
    ...
    - main [ref=e56]:
      - status "Loading dashboard..." [ref=e57]:
        - paragraph [ref=e59]: Loading dashboard...
```