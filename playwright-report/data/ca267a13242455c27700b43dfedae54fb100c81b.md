...
- Name: daily-operations.spec.ts >> Daily Operations Manager Workspace Console >> should verify log date section and Today badge
- Location: tests\e2e\daily-operations.spec.ts:26:7
