...
- Name: daily-operations.spec.ts >> Daily Operations Manager Workspace Console >> should open daily operations modal and verify quick statistics
- Location: tests\e2e\daily-operations.spec.ts:54:7
...
- generic [ref=e3]:
  ...
  - generic [ref=e36]:
    ...
    - main [ref=e56]:
      - status "Loading daily operations..." [ref=e57]:
        - paragraph [ref=e59]: Loading daily operations...
```