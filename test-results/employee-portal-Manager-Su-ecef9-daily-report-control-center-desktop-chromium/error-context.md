...
- Name: employee-portal.spec.ts >> Manager Submissions Dashboard >> should display manager daily report control center
- Location: tests\e2e\employee-portal.spec.ts:45:7
...
Locator: locator('h1')
Expected substring: "Employee Daily Reports Dashboard"
