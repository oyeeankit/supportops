...
- Name: dashboard.spec.ts >> MVP Manager Dashboard >> should render 4 MVP summary KPI cards and Today's Daily Reports table
- Location: tests\e2e\dashboard.spec.ts:25:7
...
Locator: locator('text=Present Employees')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Present Employees')
