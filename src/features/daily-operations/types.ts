...
export const appsByPlatform: Record<string, readonly string[]> = {
  ...
  ecommerce: ["Custom Store App", "E-commerce App QA"],
  wix: ["Pro Bulk Editor", "Spreadr", "Wix Integration App"],
  csv: ["Bulk CSV Importer", "CSV Bulk Importer"],
  other: ["Custom App Testing", "Custom Feature App"],
